...
from tf.project.segmentation.data_loader import DataGeneratorFromDict
from tf.project.segmentation.lib.preprocessing import *
...
#IF mode == binary : choose a method 
#mode = 'binary'
